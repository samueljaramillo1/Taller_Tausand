...
class Aplicacion_Gui(QWidget):
    ...
    def inicializar_GUI(self):
        ...
        #Creamos la caja superior
        self.caja_superior = QGroupBox("Suma con gráfico")
        distr_caja_superior = QGridLayout()
        self.caja_superior.setLayout(distr_caja_superior)

        #Creamos las etiquetas y campos de texto de los numeros en la caja superior
        ...
        #Agregamos a la caja superior
        distr_caja_superior.addWidget(self.etiqueta_numero, 0,0)
        distr_caja_superior.addWidget(self.mensaje_numero,2,0)

        #Agregamos a la caja superior los campos de texto
        distr_caja_superior.addWidget(self.txt_numero, 0,1)
        ...
        self.distr_vertical.addWidget(self.caja_superior)
